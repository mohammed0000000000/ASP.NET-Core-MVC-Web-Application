...
namespace TechWebApplication.Migrations
{
    ...
    [Migration("20240927084856_fix identity eror in model Content")]
    partial class fixidentityerorinmodelContent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TechWebApplication.Models.Entities.CategoryItem", b =>
                {
                    ...
                    b.Property<DateTime>("DateTimeItemReleased")
                        ...
                        .HasDefaultValue(new DateTime(2024, 9, 27, 11, 48, 54, 579, DateTimeKind.Local).AddTicks(8214));
